...
particles.push({color1:Math.random()*256,color1:Math.random()*256,color1:Math.random()*256, x:Math.random()*W,y:Math.random()*H,r:Math.random()*4+1,d:Math.random()*antalflingor});
